/**
 * Full ISO 3166-1 list (name + alpha-2 code) rather than a curated subset —
 * a live export sales team will add customers from countries not seen in
 * any one batch of historical data. The code is what flags.ts uses to
 * derive the flag emoji at render time (two Unicode regional-indicator
 * symbols per code) — storing codes here instead of baking in emoji
 * strings directly means one systematic source of truth instead of 195
 * hand-typed emoji that are easy to get subtly wrong.
 */
...
export const COUNTRIES: CountryEntry[] = [
  ...
  { name: "Cape Verde", code: "CV" }, { name: "Chad", code: "TD" }, { name: "Chile", code: "CL" },
  { name: "China", code: "CN" }, { name: "Colombia", code: "CO" }, { name: "Comoros", code: "KM" },
  { name: "Congo (DRC)", code: "CD" }, { name: "Congo (Republic)", code: "CG" }, { name: "Costa Rica", code: "CR" },
  ...
  { name: "El Salvador", code: "SV" }, { name: "Estonia", code: "EE" }, { name: "Eswatini", code: "SZ" },
  ...
  { name: "Russia", code: "RU" }, { name: "Rwanda", code: "RW" }, { name: "Samoa", code: "WS" },
  ...
  { name: "United Kingdom", code: "GB" }, { name: "USA", code: "US" }, { name: "Uruguay", code: "UY" },
